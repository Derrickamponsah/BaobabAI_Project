...
class AppTheme {
  static const Color primary = Color(0xFF1B2A47); // Navy blue text/headers
  static const Color secondary = Color(0xFF57A773);
  ...
  static const Color textDark = Color(0xFF1B2A47);
